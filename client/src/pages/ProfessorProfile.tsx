            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              {user ? (
                <a
                  ...
                  className="flex items-center gap-2 bg-neon-dim border border-neon px-4 py-2 text-xs font-medium text-neon transition-all hover:bg-neon hover:text-paper"
                >
                ...
                <a
                  href="/login"
                  className="flex items-center gap-2 border border-hairline-strong px-4 py-2 text-xs text-stone hover:border-navy hover:text-navy"
                >
                  <Mail size={13} /> Login to Email
                </a>
              )}
              {professor.website && (
                <a
